<div class="attribute-container" id="attribute-object-relation-{{$attribute->id}}-{{$locale}}">
    ...
    <a href="javascript:;" class="btn btn-info btn-xs attribute-object-relation-add">{{trans("admin::admin.select_object")}}</a>
    <a href="javascript:;" class="btn btn-primary btn-xs attribute-object-relation-create">{{trans("admin::admin.create_object")}}</a>
