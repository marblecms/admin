<div class="attribute-container" id="attribute-object-relation-list-{{$attribute->id}}-{{$locale}}">
    ...
    <a href="javascript:;" class="btn btn-info btn-xs attribute-object-relation-list-add">{{trans("admin.select_object")}}</a>
    <a href="javascript:;" class="btn btn-primary btn-xs attribute-object-relation-list-create">{{trans("admin.create_object")}}</a>
