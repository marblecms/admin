$(function($) {
    ...
    $('#sidebar-nav .dropdown-toggle i').on('click', function(e) {
        e.preventDefault();
...
$("#search-field").keyup(debounce(function(){
    ...
    $.get("/admin/node/search.json?q=" + encodeURIComponent(query), function(nodes){
        ...
        for(var key in nodes){
            $searchResults.append('<li class="list-group-item"><a href="/admin/node/edit/' + nodes[key].id + '">' + nodes[key].name + '</a></li>');
        }
