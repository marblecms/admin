...
return [
    ...
    'quick_create'              => 'New',
    'my_pending_items'          => 'Pending Review',
    'my_drafts'                 => 'My Drafts',

    // Traffic
    'traffic'                   => 'Traffic',
    'traffic_pageviews'         => 'Pageviews',
    'traffic_referrers'         => 'Referrers',
    'traffic_total_views'       => 'Total Views',
    'traffic_sessions'          => 'Sessions',
    'traffic_last_7'            => 'Last 7 days',
    'traffic_last_30'           => 'Last 30 days',
    'traffic_last_90'           => 'Last 90 days',
    'traffic_no_data'           => 'No traffic data yet.',
    'traffic_no_referrers'      => 'No referrers recorded.',
    ...
    'add_task'                  => 'Add Task',
    'add_comment'               => 'Comment',
    'task_title_placeholder'    => 'Task description…',
    'comment_placeholder'       => 'Write a comment…',
    'assign_to_nobody'          => '— Unassigned',
    'mark_done'                 => 'Mark as done',
    'mark_undone'               => 'Mark as open',
    ...
    'ab_results'                => 'Results',
    'ab_no_impressions'         => 'No impressions yet.',
    'ab_not_enough_data'        => 'Need at least :min impressions per bucket for reliable results.',
    ...
    // Plugin Marketplace
    'plugins'                      => 'Plugins',
    'plugins_hint'                 => 'Browse and install Marble CMS plugins from the community.',
    'plugins_search_placeholder'   => 'Search plugins…',
    'plugins_found'                => 'packages found',
    'plugins_for'                  => 'for',
    'plugins_no_results'           => 'No plugins found for',
    'plugins_empty'                => 'No plugins found. Try a different search term.',
    'plugin_verified'              => 'Verified',
    'plugin_featured'              => 'Featured',
    'plugin_latest_version'        => 'Latest Version',
    'plugin_downloads'             => 'Downloads',
    'plugin_maintainers'           => 'Maintainers',
    'plugin_license'               => 'License',
    'plugin_homepage'              => 'Homepage',
    'plugin_packagist'             => 'Packagist',
    'plugin_requires_marble'       => 'Requires Marble',
    'plugin_install_hint'          => 'Run this command in your project root to install the plugin:',
    ...
    'ai_settings_hint'          => 'Configure an AI provider to enable the AI assistant button in the rich text editor.',
    'ai_provider'               => 'Provider',
    'ai_api_key'                => 'API Key',
    'ai_api_key_hint'           => 'Your API key. Stored securely; shown masked after saving.',
    'ai_api_key_placeholder'    => 'Paste your API key here…',
    'ai_model'                  => 'Model',
    'ai_model_hint'             => 'Leave blank to use the default (gpt-4o / claude-sonnet-4-6).',
    'disabled'                  => 'Disabled',
    ...
    'two_factor_backup_hint'    => 'Lost your device? Enter one of your backup codes instead.',
    'two_factor_invalid_code'   => 'Invalid authentication code. Please try again.',
    'two_factor_session_expired'=> 'Setup session expired. Please start again.',
    'two_factor_active'         => '2FA enabled',
    'two_factor_active_hint'    => 'Two-factor authentication is currently active for this account.',
    'two_factor_setup_hint'     => 'Protect this account with an authenticator app (Google Authenticator, Authy, 1Password, etc.).',
    'two_factor_setup'          => 'Set up 2FA',
    'two_factor_manual_key'     => 'Or enter this key manually',
    'two_factor_enter_code'     => 'Enter the 6-digit code from your app to confirm setup',
    'two_factor_confirm_enable' => 'Confirm & Enable',
    ...
    'two_factor_backup_codes_save' => 'Save these backup codes in a safe place. Each can only be used once.',
